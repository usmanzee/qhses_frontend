...
export const EditEraAssessmentFormDrawer = (props) => {
  const {
    visible,
    setVisible,
    form,
        ...
        <Form form={form} onFinish={handleFormSubmit} layout="vertical">
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              ...
              >
                <Select disabled placeholder="Select Risk Type">
          ...
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Input disabled placeholder="Input Risk Area" />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
              ...
              >
                <Input
                  disabled
                  placeholder="e.g: Change Management, Incident Management, Manpower / Staff Shortages"
                />
              </Form.Item>
            </Col>
          </Row>
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Select disabled placeholder="Select Likelihood">
            ...
            <Col span={12}>
              ...
              >
                <Select disabled placeholder="Select Consequence">
          ...
          <Row gutter={16}>
            <Col span={24}>
              <Form.Item
                label="Progress and Compliance Reporting"
                name="progress_reporting"
                rules={[
                  {
                    required: false,
                    message: "Progress Reporting is required",
                  },
                ]}
              >
                <Input.TextArea
                  placeholder="Input Progress and Compliance Reporting"
                  autoSize={{ minRows: 5, maxRows: 5 }}
                  showCount
                />
              </Form.Item>
          ...
          <Row gutter={16}>
            <Col span={24}>
              ...
              >
                <Input placeholder="e.g: IT, Human Resource, QHSSE" />
              </Form.Item>
            </Col>
          </Row>
        </Form>
