...
import { getCompaniesAction, addHiraRecordAction } from "../../redux/actions";
...
const AddHiraRecord = () => {
  ...
  const addLoading = useSelector((state) => state.hiraRecords.addLoading);
  ...
  const onRecordFormSubmit = (values) => {
    ...
    dispatch(addHiraRecordAction(history, values));
  };
